...
restore_env_overrides() {
  ...
  if [ -n "${ENV_API_SERVER_TTS_MAX_NEW_TOKENS_SET}" ]; then export API_SERVER_TTS_MAX_NEW_TOKENS="${ENV_API_SERVER_TTS_MAX_NEW_TOKENS}"; fi
  if [ -n "${ENV_API_SERVER_LLAMA_MAX_SEQ_LEN_SET}" ]; then export API_SERVER_LLAMA_MAX_SEQ_LEN="${ENV_API_SERVER_LLAMA_MAX_SEQ_LEN}"; fi
