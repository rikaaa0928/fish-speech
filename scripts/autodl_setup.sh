...
ENV_API_SERVER_TTS_MAX_NEW_TOKENS_SET="${API_SERVER_TTS_MAX_NEW_TOKENS+x}"
ENV_API_SERVER_TTS_MAX_NEW_TOKENS="${API_SERVER_TTS_MAX_NEW_TOKENS-}"
ENV_API_SERVER_LLAMA_MAX_SEQ_LEN_SET="${API_SERVER_LLAMA_MAX_SEQ_LEN+x}"
ENV_API_SERVER_LLAMA_MAX_SEQ_LEN="${API_SERVER_LLAMA_MAX_SEQ_LEN-}"
...
load_existing_envs() {
  ...
  if [ -n "${ENV_API_SERVER_TTS_MAX_NEW_TOKENS_SET}" ]; then API_SERVER_TTS_MAX_NEW_TOKENS="${ENV_API_SERVER_TTS_MAX_NEW_TOKENS}"; fi
  if [ -n "${ENV_API_SERVER_LLAMA_MAX_SEQ_LEN_SET}" ]; then API_SERVER_LLAMA_MAX_SEQ_LEN="${ENV_API_SERVER_LLAMA_MAX_SEQ_LEN}"; fi
...
write_worker_env() {
  ...
  API_SERVER_MAX_QUEUED_REQUESTS="${API_SERVER_MAX_QUEUED_REQUESTS:-1}"
  API_SERVER_TTS_MAX_NEW_TOKENS="${API_SERVER_TTS_MAX_NEW_TOKENS-4096}"
  API_SERVER_LLAMA_MAX_SEQ_LEN="${API_SERVER_LLAMA_MAX_SEQ_LEN-8192}"
  ...
  umask 077
  {
    ...
    printf 'API_SERVER_LLAMA_MAX_SEQ_LEN=%s\n' "${API_SERVER_LLAMA_MAX_SEQ_LEN}"
